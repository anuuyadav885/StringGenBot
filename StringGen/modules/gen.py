...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("https://t.me/+fK5x8NgiYKQ0ZThl"))
        else:
            ...
            await client.join_chat("Tapori_String_Bot")
    except KeyError:
        pass
    try:
